...
**You will get an acknowledgement within 14 days**, and in practice sooner. Trinity is maintained
by the people named in `MAINTAINERS.md` and has no paid security staff, so that is the target the
project holds itself to rather than a contractual commitment; if you have not heard back in 14
days, send the report again.
