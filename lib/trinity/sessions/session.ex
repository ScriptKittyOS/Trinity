...
defmodule Trinity.Sessions.Session do
  @moduledoc """
  A conversation. Slice 010 owns the row; slice 012 owns the process that runs it. `origin`
  and `status` are strings with a closed vocabulary from docs/05, validated here.
  """
  use Ecto.Schema
  ...
  schema "sessions" do
    ...
    has_many :messages, Trinity.Sessions.Message
    timestamps()
  end
